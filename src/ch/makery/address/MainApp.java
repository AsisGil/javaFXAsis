...
public class MainApp extends Application {
	 ...
	 */
	private ObservableList<Television> datosJuego = FXCollections.observableArrayList();
	...
	public MainApp() {
		...
		datosJuego.add(new Television("H20 SAMRT", "2015"));
		datosJuego.add(new Television("UHD 234", "2015"));
	 ...
	 */
	public boolean showPersonEditDialog(Television person) {
		try {
	 ...
	 * @return
	 */
	public ObservableList<Television> getPersonData() {
		return datosJuego;
	}
